...
Welcome to ALP Turk API docs!

Service ALP Turk provides open API for trading operations and broadcasting of all trading events.

# HTTP API (v1)


HTTP API endpoint available on [https://alptr.com/api/v1/](https://alptr.com/api/v1/).
...
const BASE_URL = 'https://alptr.com/api/v1';
...
In order for access to private API methods, generate authorization keys [in profile settings](https://alptr.com/en/profile/api).
...
response = requests.get('https://alptr.com/api/v1/currencies/')
```

```javascript
var request = require('request');

request.get('https://alptr.com/api/v1/currencies/', function (error, response, body) {
    // process response
});
```
...
`GET https://alptr.com/api/v1/currencies/`
...
response = requests.get('https://alptr.com/api/v1/pairs/')
```

```javascript
var request = require('request');

request.get('https://alptr.com/api/v1/pairs/', function (error, response, body) {
    // process response
});
```
...
`GET https://alptr.com/api/v1/pairs/`
...
response = requests.get('https://alptr.com/api/v1/ticker/')
```

```javascript
var request = require('request');

request.get('https://alptr.com/api/v1/ticker/', function (error, response, body) {
    // process response
});
```
...
`GET https://alptr.com/api/v1/ticker/`
...
response = requests.get('https://alptr.com/api/charts/BTC_USD/60/chart', params = params)
```
...
request.get({
                url: 'https://alptr.com/api/charts/BTC_USD/60/chart',
                qs: params
...
`GET https://alptr.com/api/charts/<pair_symbol>/<timeframe>/chart`
...
response = requests.get('https://alptr.com/api/v1/wallets/', headers = get_auth_headers({}))
```
...
request.get(
    'https://alptr.com/api/v1/wallets/',
    {
...
`GET https://alptr.com/api/v1/wallets/`
...
response = requests.get('https://alptr.com/api/v1/orderbook/BTC_USD', params=params)
```

```javascript
var request = require('request');

var url = 'https://alptr.com/api/v1/orderbook/BTC_USD';
...
`GET https://alptr.com/api/v1/orderbook/<pair_name>`
...
response = requests.get('https://alptr.com/api/v1/orders/own/', headers = get_auth_headers({}))
```

```javascript
var request = require('request');

request.get('https://alptr.com/api/v1/orders/own/', {headers: getAuthHeaders({})}, function (error, response, body) {
    // process response
});
```
...
`GET https://alptr.com/api/v1/orders/own/`
...
response = requests.get('https://alptr.com/api/v1/order/{}/'.format(oid))
```
...
request.get('https://alptr.com/api/v1/order/' + oid + '/', function (error, response, body) {
    // process response
});
```
...
`GET https://alptr.com/api/v1/order/<pk>/`
...
response = requests.post('https://alptr.com/api/v1/order/', data = order, headers = get_auth_headers(order))
```
...
request.post({
                url: 'https://alptr.com/api/v1/order/',
                form: order,
                headers: getAuthHeaders(order)
            }, function (error, response, body) {
                // process response
...
`POST https://alptr.com/api/v1/order/`
...
response = requests.post('https://alptr.com/api/v1/order-cancel/', data = data, headers = get_auth_headers(data))
```
...
request.post({
        url: 'https://alptr.com/api/v1/order-cancel/',
        form: data,
...
`POST https://alptr.com/api/v1/order-cancel/`
...
response = requests.get('https://alptr.com/api/v1/exchanges/')
```

```javascript
var request = require('request');

request.get('https://alptr.com/api/v1/exchanges/', function (error, response, body) {
    // process response
});
```
...
`GET https://alptr.com/api/v1/exchanges/`
...
`GET https://alptr.com/api/v1/exchanges/own/`
...
response = requests.get('https://alptr.com/api/v1/deposits/', headers = get_auth_headers({}))
```
...
request.get({
                url: 'https://alptr.com/api/v1/deposits/',
                headers: getAuthHeaders({})
            }, function (error, response, body) {
                // process response
            }
...
`GET https://alptr.com/api/v1/deposits/`
...
response = requests.get('https://alptr.com/api/v1/withdraws/', headers: get_auth_headers({}))
```
...
request.get({
        url: 'https://alptr.com/api/v1/withdraws/',
        headers: getAuthHeaders({})
    }, function (error, response, body) {
        // process response
    }
...
`GET https://alptr.com/api/v1/withdraws/`
